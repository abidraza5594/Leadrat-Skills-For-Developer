import { GENERATED_END, GENERATED_START, MANAGED_MARKER, } from '../core/constants.js';
export function createManagedDocument(title, generatedBody) {
    return [
        `<!-- ${MANAGED_MARKER} -->`,
        `# ${title}`,
        '',
...
export function mergeGeneratedDocument(existing, nextDocument) {
    if (!existing) {
        return nextDocument;
    }
...
function extractGeneratedBlock(document) {
...
//# sourceMappingURL=document-merger.js.map