...
program
  ...
  .option('--azure-org <organization>', 'Azure DevOps organization; defaults to gharoffice')
  .option('--azure-project <project>', 'Azure DevOps project name; defaults to Leadrat-Black')
