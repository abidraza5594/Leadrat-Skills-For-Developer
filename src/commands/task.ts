...
import type { TaskCommandOptions } from '../core/types.js';
...
export async function taskCommand(options: TaskCommandOptions): Promise<void> {
...
async function fetchAzureWorkItem(options: TaskCommandOptions) {
...
async function fetchFigmaContext(figmaReference: string) {
...
function resolveOutputPath(repoRoot: string, output: string | undefined, defaultFileName: string): string {
  if (output) {
